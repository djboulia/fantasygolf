angular.module('CloudApp')
  .controller('RosterEventCtrl', ['$scope', '$stateParams', '$uibModal', '$cookieStore',
    '$location', '$sanitize', 'cloudDataCurrentUser',
    'cdFantasy', RosterEventCtrl
  ]);


function RosterEventCtrl($scope, $stateParams, $uibModal, $cookieStore,
  ...
  var findEventPlayers = function(players) {
    var list = [];
  ...
  var loadRoster = function() {
    ...
    if (gameid) {
      ...
      fantasy.getEventRoster(gameid,eventid)
        .then(function(roster) {
            ...
            var eventPlayers = findEventPlayers(roster.players);

            $scope.name = roster.game.name;
            $scope.eventName = roster.event.name;
            $scope.players = eventPlayers;
