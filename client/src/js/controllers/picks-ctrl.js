...
function PicksCtrl($scope, $stateParams, $cookieStore,
  ...
  var findEvent = function(id, schedule) {
  ...
  if (gameid) {
    ...
    fantasy.getSchedule(gameid)
      .then(function(schedule) {

        var event = findEvent(eventid, schedule);
        ...
        return fantasy.getPicks(gameid, eventid, currentUser); // promise
      })
      .then(function(obj) {
